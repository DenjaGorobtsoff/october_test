 ...
 * Generated for Laravel 5.5.48 on 2019-11-18 01:09:28.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Lang {
        ...
        public static function has($key, $locale = null)
        {
                        ...
                        return $instance->has($key, $locale);
        }
        ...
        {
                        /** @var \October\Rain\Translation\Translator $instance */
                        return $instance->trans($id, $parameters, $domain, $locale);
        }
        ...
        {
                        /** @var \October\Rain\Translation\Translator $instance */
                        return $instance->transChoice($id, $number, $parameters, $domain, $locale);
        }
    ...
    class URL {
         ...
         * @static 
         */ 
        public static function buildUrl($url, $replace = array(), $flags = 1, $newUrl = array())
        {
...
namespace October\Rain\Support\Facades { 
    ...
    class Block {
        ...
        {
                        /** @var \October\Rain\Html\BlockBuilder $instance */
                        return $instance->startBlock($name);
        }
        ...
        {
                        /** @var \October\Rain\Html\BlockBuilder $instance */
                        return $instance->endBlock($append);
        }
        ...
        {
                        /** @var \October\Rain\Html\BlockBuilder $instance */
                        return $instance->set($name, $content);
        }
        ...
        {
                        /** @var \October\Rain\Html\BlockBuilder $instance */
                        return $instance->append($name, $content);
        }
